...
local LM, parent = torch.class('nn.LanguageModel_dec', 'nn.Module')
...
function LM:forwardConnect(encoder)
  for i = 1, self.num_layers do
    self.rnns[i].h0 = encoder.rnns[i].h0
    self.rnns[i].c0 = encoder.rnns[i].c0
  end
end
